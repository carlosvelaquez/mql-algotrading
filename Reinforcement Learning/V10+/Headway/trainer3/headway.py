...
class Headway(gym.Env):
    def __init__(self, history_path="./history", min_target_pts=25, max_target_pts=250, max_loss=25000, gamma=.995, norm_obs=True, warmup_steps=0, debug=1):
        # Parameters
    ...
    def step(self, action):
        ...
        if (target_percentage != 0) and (self.current_pos > self.warmup_steps):
            self.total_orders += 1
